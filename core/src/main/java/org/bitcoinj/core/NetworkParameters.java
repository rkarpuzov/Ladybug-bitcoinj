...
public abstract class NetworkParameters implements Serializable {
    ...
    private static Block createGenesis(NetworkParameters n) {
        ...
        try {
            ...
            //
            //   "27/11/2015 Putin: Oil that Turkey buys from terrorists is mixed with Russian blood"
            byte[] bytes = Utils.HEX.decode
                    ("04ffff001d01044c5232372f31312f3230313520507574696e3a204f696c2074686174205475726b657920627579732066726f6d20746572726f7269737473206973206d697865642077697468205275737369616e20626c6f6f64");
    ...
    public static final int TARGET_TIMESPAN = 18000;  // 2 weeks per difficulty cycle, on average.
