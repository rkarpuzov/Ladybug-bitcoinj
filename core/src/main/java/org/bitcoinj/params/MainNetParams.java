...
public class MainNetParams extends NetworkParameters {
	...
	genesisBlock.setTime(1448621995L);
	genesisBlock.setNonce(2826399945L);
        id = ID_MAINNET;
//        subsidyDecreaseBlockCount = 210000;
        spendableCoinbaseDepth = 100;
        String genesisHash = genesisBlock.getHashAsString();
        checkState(genesisHash.equals("0000000066247638c1b022cb6f224c2600e6ad8d3d1bb48e869bb7a153f3be1d"),
                genesisHash);
...
//        checkpoints.put(371900, new Sha256Hash("00000000000d4eff28cd43af373914a511f58fbe9a2b1c4efd3b537493330cf3"));
        ...
        dnsSeeds = new String[] {
	         "ladybug.cointech.net",        // 
                 "mobi.cointech.net",         // 
                 "pool.cointech.net",  // 
                 "bugseed.cointech.net",       // 
		};
    }
